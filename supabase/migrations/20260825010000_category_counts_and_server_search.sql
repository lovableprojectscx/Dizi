-- Migración: Conteo Real de Productos por Categoría y Búsqueda en Servidor
-- Fecha: 2026-08-25

-- 1. Actualizar get_public_store con conteo real de productos por categoría
...
-- 2. Asegurar que get_public_store_products busque por nombre y descripción
