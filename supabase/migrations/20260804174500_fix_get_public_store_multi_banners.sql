-- Migration: Fix get_public_store RPC to return all multi-banners from banners array concatenated with '|||'
-- Date: 2026-08-04

UPDATE stores
SET banner_image = array_to_string(banners, '|||')
WHERE banners IS NOT NULL AND array_length(banners, 1) > 1;
