-- Migration: Add banner_tagline and banner_bottom_tag to stores and update get_public_store RPC
ALTER TABLE stores ADD COLUMN IF NOT EXISTS banner_tagline text DEFAULT NULL;
ALTER TABLE stores ADD COLUMN IF NOT EXISTS banner_bottom_tag text DEFAULT NULL;

-- Update get_public_store RPC to return the new tagline columns
