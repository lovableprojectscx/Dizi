-- Migration: Add text_color to stores and update get_public_store RPC
ALTER TABLE stores ADD COLUMN IF NOT EXISTS text_color text DEFAULT NULL;

-- Update get_public_store RPC to return text_color
