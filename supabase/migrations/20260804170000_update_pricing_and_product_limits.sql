-- Migration: Update get_public_store RPC with new product limits per plan (Semilla: 20, Emprendedor: 100, Pro: 300, Ilimitado: 1000)
-- Date: 2026-08-04
...
BEGIN
  ...
  -- Determinar el límite de productos del plan efectivo (Estructura de Agosto 2026)
