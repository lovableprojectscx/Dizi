-- Migration: Add show_dizi_branding to stores and update get_public_store RPC

-- 1. Añadir la columna show_dizi_branding a la tabla stores
ALTER TABLE public.stores
ADD COLUMN show_dizi_branding boolean DEFAULT true;

-- 2. Actualizar la función RPC get_public_store
