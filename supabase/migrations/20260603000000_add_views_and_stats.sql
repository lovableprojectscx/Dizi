-- =========================================================================================
-- MIGRACIÓN: Agregar columna de vistas (visitas) y funciones RPC de estadísticas
-- Fecha: 2026-06-03
-- =========================================================================================

-- 1. Agregar columna views si no existe en la tabla stores
...
-- 4. Otorgar permisos de ejecución para roles públicos/autenticados
GRANT EXECUTE ON FUNCTION increment_views TO anon, authenticated;
GRANT EXECUTE ON FUNCTION increment_whatsapp_clicks TO anon, authenticated;

-- 5. Actualizar get_public_store para incluir la columna de vistas en el JSON retornado
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'views', COALESCE(store_row.views, 0), -- Campo agregado para estadísticas de visitas
