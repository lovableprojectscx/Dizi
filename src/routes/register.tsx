          ...
          <div className="w-full max-w-sm">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                {
                  name: "WeHome Peru", desc: "Inmobiliaria", href: "https://dizi.idenza.site/bio/wehomeperu",
                  icon: <svg viewBox="0 0 48 48" className="w-9 h-9" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="hroof" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#ff8a65"/><stop offset="100%" stopColor="#e64a19"/></linearGradient><linearGradient id="hwall" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#ffe0d0"/><stop offset="100%" stopColor="#ffccbc"/></linearGradient><linearGradient id="hdoor" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#8d6e63"/><stop offset="100%" stopColor="#4e342e"/></linearGradient></defs><polygon points="24,6 6,22 42,22" fill="url(#hroof)" filter="drop-shadow(0 2px 3px rgba(0,0,0,0.25))"/><rect x="10" y="21" width="28" height="20" rx="1.5" fill="url(#hwall)" filter="drop-shadow(0 3px 4px rgba(0,0,0,0.15))"/><rect x="16" y="26" width="6" height="6" rx="1" fill="#90caf9" opacity="0.9"/><rect x="26" y="26" width="6" height="6" rx="1" fill="#90caf9" opacity="0.9"/><rect x="19" y="31" width="10" height="10" rx="1" fill="url(#hdoor)"/><circle cx="27.5" cy="36.5" r="1" fill="#ffd54f"/></svg>
                },
                {
