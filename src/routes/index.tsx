...
const IconFriction3D = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect
      ...
      fill="#000"
      opacity="0.1"
      transform="rotate(-5 50 50) translate(0, 4)"
    />
    <path
      d="M25 20 C25 17, 27 15, 30 15 L60 15 L75 30 L75 80 C75 83, 73 85, 70 85 L30 85 C27 85, 25 83, 25 80 Z"
      fill="url(#docBg)"
      filter="url(#shadow)"
    />
    <path
      d="M60 15 L75 30 L63 30 C61 30, 60 29, 60 27 Z"
      fill="url(#docFold)"
      filter="url(#shadow)"
    />
    <line
    ...
    <g filter="url(#arrowGlow)">
      <path
        d="M50 35 L50 63 M42 55 L50 63 L58 55"
  ...
  head: () => ({
    meta: [
      { title: "Dizi — Catálogos Digitales para MYPEs | Vende por WhatsApp" },
      {
        name: "description",
        content:
          "Crea tu catálogo digital gratis en 2 minutos. Vende por WhatsApp sin descargas. Plataforma 100% móvil para MYPEs peruanas. Planes desde S/ 0.00.",
      },
      {
        name: "keywords",
        content:
          "catálogo digital gratis, tienda virtual WhatsApp, MYPE Perú, catálogo online Perú, vender por WhatsApp, catálogo web interactivo, digitalizar tienda Perú",
      },
      { property: "og:url", content: "https://dizi.idenza.site/" },
      {
        property: "og:title",
        content: "Dizi — Catálogos Digitales para MYPEs | Vende por WhatsApp",
      },
      {
        property: "og:description",
        content:
          "Crea tu catálogo digital gratis en 2 minutos. Vende por WhatsApp sin descargas. Plataforma 100% móvil para MYPEs peruanas.",
      },
...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md">
        <div className="container mx-auto max-w-6xl px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
            ...
            <a href="#solucion" className="hover:text-foreground transition-colors">
              Solución
            </a>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              asChild
              className="hidden md:flex shadow-lg shadow-primary/20 transition-all hover:scale-105"
            >
      ...
      >
        <div
          className="w-14 h-14 rounded-full flex items-center justify-center transition-transform group-hover:scale-110 active:scale-95 relative"
          style={{ background: "#0f172a", border: "2.5px solid #4ade80" }}
        >
          {/* Soccer Ball icon inside circular button */}
          <svg
            viewBox="0 0 100 100"
            className="w-8 h-8 transition-transform duration-700 group-hover:rotate-[360deg] pointer-events-none"
          ...
          >
            ...
            <path
              d="M50,4 L50,18 M88,30 L76,35 M74,70 L62,76 M26,70 L38,76 M12,30 L24,35"
              stroke="#4b5563"
              strokeWidth="2.5"
              fill="none"
            />
        ...
        <span
          className="text-[9px] font-black px-2 py-0.5 rounded-full whitespace-nowrap tracking-wider"
      ...
      <main className="overflow-hidden">
        ...
        <section className="relative pt-20 pb-20 lg:pt-32 lg:pb-24 overflow-hidden bg-gradient-to-b from-[#fffaf7] via-background to-background">
          ...
          <div
            className="absolute top-[10%] right-[-15%] w-[45%] h-[55%] rounded-full bg-lavender/10 blur-[120px] animate-morph pointer-events-none"
            style={{ animationDelay: "-4s" }}
          />
          <div
            className="absolute bottom-[-10%] left-[20%] w-[40%] h-[50%] rounded-full bg-emerald-200/10 blur-[100px] animate-morph pointer-events-none"
          ...
          <div className="absolute left-[8%] top-[25%] hidden xl:block animate-float opacity-90 pointer-events-none">
            <svg viewBox="0 0 120 120" className="w-24 h-24" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M20,50 C20,30 40,20 60,20 C80,20 100,30 100,50 C100,70 80,100 60,100 C40,100 20,70 20,50 Z"
                fill="url(#clayOrange)"
                filter="drop-shadow(2px 10px 15px rgba(251,146,60,0.3))"
              />
              <defs>
          ...
          <div className="absolute right-[8%] top-[30%] hidden xl:block animate-float-reverse opacity-80 pointer-events-none">
            <svg viewBox="0 0 120 120" className="w-24 h-24" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M20,50 C20,30 40,20 60,20 C80,20 100,30 100,50 C100,70 80,100 60,100 C40,100 20,70 20,50 Z"
                fill="url(#clayPurple)"
                filter="drop-shadow(2px 10px 15px rgba(188,132,238,0.3))"
              />
              <defs>
          ...
          <div className="container relative z-10 mx-auto max-w-6xl px-4 text-center">
            ...
            <p className="text-base md:text-xl text-zinc-600 max-w-2xl mx-auto mb-10 leading-relaxed px-2">
              Digitalizando el comercio local peruano con velocidad y simplicidad. Crea tu tienda en
              2 minutos y empieza a vender por WhatsApp.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 px-4 sm:px-0">
              <Button
                size="lg"
                asChild
                className="text-base h-12 sm:h-14 px-8 shadow-md transition-transform hover:-translate-y-0.5"
              >
                <Link to="/register">
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="text-base h-12 sm:h-14 px-8 bg-white/80 hover:bg-white transition-colors"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-zinc-500 font-medium">
              <span className="flex items-center gap-1.5 whitespace-nowrap">
                <CheckCircle2 className="w-4 h-4 text-primary" /> Sin descargas
              </span>
              <span className="flex items-center gap-1.5 whitespace-nowrap">
                <CheckCircle2 className="w-4 h-4 text-primary" /> 100% Móvil
              </span>
              <span className="flex items-center gap-1.5 whitespace-nowrap">
                <CheckCircle2 className="w-4 h-4 text-primary" /> Tiempo Real
              </span>
            </div>
            ...
            <div className="mt-16 relative w-full overflow-hidden py-10">
              ...
              <div className="animate-infinite-scroll gap-6">
                {[...MOCKUPS, ...MOCKUPS].map((m, idx) => (
                  <div
                    key={idx}
                    className="w-52 h-80 bg-background rounded-3xl border shadow-xl flex flex-col overflow-hidden shrink-0 transform hover:-translate-y-4 hover:scale-105 transition-all duration-500 cursor-pointer relative group"
                  >
                    ...
                    <div className="h-[250px] w-full overflow-hidden bg-muted relative">
                      <img
                        src={m.path}
                        alt={m.name}
                        className="absolute inset-0 h-full w-full object-cover object-top group-hover:scale-110 transition-transform duration-700"
                      />
                    </div>
          ...
          <div className="container mx-auto max-w-6xl px-4 relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-background p-6 rounded-2xl border shadow-sm flex flex-col items-center text-center hover:border-primary/40 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
                >
                  <div className="mb-6 h-16 w-16 flex items-center justify-center">{item.icon}</div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed">
                  Transformamos la forma en que tus clientes compran. Un sistema tan fácil que tu
                  cliente no querrá comprar de otra manera.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    <div className="mt-1 flex-shrink-0">
                      ...
                      >
                        <defs>
                          <linearGradient id="lupGlass" x1="0" y1="0" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#ffffff" stopOpacity="0.9" />
                            <stop offset="100%" stopColor="#ffb74d" stopOpacity="0.2" />
                          </linearGradient>
                          <linearGradient id="lupFrame" x1="0" y1="0" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#ffb74d" />
                            <stop offset="100%" stopColor="#ff7043" />
                          </linearGradient>
                        </defs>
                        ...
                        />
                        <circle cx="42" cy="42" r="15.5" fill="url(#lupGlass)" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold mb-1">Buscador Inteligente</h4>
                      <p className="text-muted-foreground">
                        Filtros reactivos que permiten encontrar cualquier artículo en milisegundos,
                        eliminando el abandono por frustración.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="mt-1 flex-shrink-0">
                      ...
                      >
                        ...
                        <path
                          d="M50 18 C30 18, 16 30, 16 46 C16 53, 20 60, 26 65 L22 79 L37 73 C41 74, 45 74, 50 74 C70 74, 84 62, 84 46 C84 30, 70 18, 50 18 Z"
                          fill="url(#bubbleGrad)"
                          filter="url(#shadowBubble)"
                        />
                        <path
                          d="M37 38 C39 37, 43 40, 44 42 C45 44, 43 46, 42 47 C44 50, 46 52, 49 54 C50 53, 52 51, 54 52 C56 53, 59 57, 58 59 C57 61, 53 62, 50 62 C42 62, 34 54, 34 46 C34 43, 35 39, 37 38 Z"
                          fill="#ffffff"
                          opacity="0.95"
                        />
                      </svg>
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        El cliente arma su pedido y te envía un mensaje estructurado. Solo tienes
                        que responder con tus datos de pago.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section id="modelos" className="py-24">
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Tu marca es única, tu catálogo también debería serlo. Elige entre diferentes estilos
                visuales diseñados para maximizar tus conversiones.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group relative overflow-hidden rounded-3xl border bg-background shadow-sm hover:shadow-xl transition-all">
                <div className="h-64 bg-gray-50 flex items-center justify-center p-0 relative overflow-hidden border-b">
                  <img
                    src="/images/mockups/boutique.png"
                    alt="Diseño Minimalista"
                    className="absolute top-4 w-[200px] h-auto rounded-t-xl shadow-xl border-x border-t transition-transform group-hover:-translate-y-2 object-cover object-top"
                  />
                </div>
                <div className="p-6 relative z-10 bg-background">
                  <h3 className="text-xl font-bold mb-2">Boutique & Moda</h3>
                  <p className="text-muted-foreground text-sm">
                    Estilo minimalista y elegante. Ideal para joyerías, moda y productos donde la
                    fotografía debe deslumbrar.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-3xl border bg-background shadow-sm hover:shadow-xl transition-all">
                <div className="h-64 bg-zinc-950 flex items-center justify-center border-b border-zinc-800 p-0 relative overflow-hidden">
                  <img
                    src="/images/mockups/tech.png"
                    alt="Diseño Nocturno"
                    className="absolute top-4 w-[200px] h-auto rounded-t-xl shadow-xl border-x border-t border-zinc-800 transition-transform group-hover:-translate-y-2 object-cover object-top"
                  />
                </div>
                <div className="p-6 relative z-10 bg-background">
                  <h3 className="text-xl font-bold mb-2">Tech & Electrónica</h3>
                  <p className="text-muted-foreground text-sm">
                    Modo oscuro nativo con acentos neón. Perfecto para tecnología, gaming y marcas
                    futuristas o de alto perfil.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-3xl border bg-background shadow-sm hover:shadow-xl transition-all">
                <div className="h-64 bg-orange-50 flex items-center justify-center border-b border-orange-100 p-0 relative overflow-hidden">
                  <img
                    src="/images/mockups/restaurant.png"
                    alt="Diseño Vibrante"
                    className="absolute top-4 w-[200px] h-auto rounded-t-xl shadow-xl border-x border-t border-orange-200 transition-transform group-hover:-translate-y-2 object-cover object-top"
                  />
                </div>
                <div className="p-6 relative z-10 bg-background">
                  <h3 className="text-xl font-bold mb-2">Gastronomía & Fast Food</h3>
                  <p className="text-muted-foreground text-sm">
                    Colores vivos y apetitosos. Pensado para restaurantes, comida rápida, postres y
        ...
        <section id="precios" className="py-24 bg-muted/30 border-t">
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Precios accesibles pensados para la penetración masiva en el mercado peruano. Sin
                comisiones ocultas.
              </p>
            </div>
            ...
            >
              ...
              <div className="px-6 py-6 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="shrink-0 flex items-end gap-1.5">
                  ...
                  <div className="mb-2">
                    <div className="text-primary text-sm font-black uppercase tracking-wider leading-tight">
                      soles
                    </div>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white/50 text-sm">
                    Llévate el plan Emprendedor a S/. 9.90 o el plan Pro a S/. 14.90. Incluye
                    configuración y diseño gratis por nuestro equipo.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-3">
                    {[
                      ...
                      <span
                        key={f}
                        className="text-[11px] font-semibold border border-white/10 text-white/50 px-2.5 py-1 rounded-full"
                      >
                        {f}
                      </span>
                    ))}
...
function PricingCard({
  ...
  return (
    <div
      className={`relative flex flex-col rounded-3xl border p-8 shadow-sm transition-all duration-300 hover:shadow-2xl glass-panel ${highlighted ? "border-primary ring-1 ring-primary/30 shadow-primary/10 lg:scale-105 z-10" : "hover:border-primary/50"}`}
    >
      {highlighted && (
      ...
      <div className="mb-6">
        ...
        <div className="text-muted-foreground text-xs font-semibold uppercase tracking-wider mt-1">
          por mes
        </div>
      </div>
      ...
      >
        {planId === "semilla" ? (
          ...
          <a
            href={`https://wa.me/51925176472?text=${encodeURIComponent(`Hola, me gustaría suscribirme al plan ${title} de Dizi.`)}`}
            target="_blank"
            rel="noreferrer"
          >
            Adquirir Plan
