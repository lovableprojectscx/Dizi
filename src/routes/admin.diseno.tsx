...
import { Lock, Check, Sparkles, Crown, Palette, Image, Sliders, Eye, Megaphone } from "lucide-react";
...
function ModelPreview({ model, storeName }: { model: ModelDef; storeName: string }) {
  ...
  const Header = () => (
    ...
    >
      <div
        className="h-4 w-4 flex items-center justify-center text-[7px] font-black text-white shrink-0"
        style={{
          borderRadius: model.imgShape === "circle" ? "999px" : "4px",
      ...
      <div
        ...
        style={{ backgroundColor: model.textColor, opacity: 0.45 }}
      />
      <div className="flex-1" />
      <div
        className="h-3 rounded-full px-1.5 text-[5px] font-bold flex items-center"
        style={{ backgroundColor: model.primaryColor, color: "#fff" }}
      >
        Contacto
      </div>
    </div>
  ...
  const SearchBar = () => (
    <div className="px-2.5 py-1 shrink-0">
      <div
        className="h-3 rounded-full w-full flex items-center px-1.5 gap-1"
        style={{ backgroundColor: model.accentColor }}
      >
        <div
          className="h-1.5 w-1.5 rounded-full"
          style={{ backgroundColor: model.primaryColor, opacity: 0.6 }}
        />
        <div
          className="h-1 rounded-full flex-1"
          style={{ backgroundColor: model.textColor, opacity: 0.25 }}
        />
      </div>
    </div>
  );
  ...
  if (model.layout === "banner_grid") {
    return (
      <div
        className="h-48 w-full overflow-hidden flex flex-col"
      ...
      >
        ...
        <div className="px-2 pt-1 pb-0.5 shrink-0">
          {/* Banner simulado */}
          <div
            className="relative w-full overflow-hidden mb-1.5"
          ...
          >
            ...
            <div
              className="absolute top-1.5 right-1.5 h-3.5 w-3.5 rounded flex items-center justify-center"
            ...
            >
              ...
              <div className="p-1 space-y-0.5">
                <div
                  ...
                  style={{ backgroundColor: model.textColor, opacity: 0.5 }}
                />
                <div className="flex items-center justify-between">
                  <div
                    className="h-1.5 rounded-full w-2/5"
                    style={{ backgroundColor: model.primaryColor, opacity: 0.9 }}
                  />
                  <div
          ...
          {Array.from({ length: cols }).map((_, i) => (
            ...
            >
              ...
              <div
                className="absolute inset-0"
                style={{
                  background: "linear-gradient(to top, rgba(0,0,0,0.82) 38%, transparent 72%)",
                }}
              />
              {/* Sale tag on first */}
              {i === 0 && (
                <div className="absolute top-1.5 left-1.5">
                  <div
                    className="text-[4.5px] font-black px-1 py-0.5 rounded-full"
            ...
            >
              ...
              <div className="flex-1 space-y-1">
                ...
                <div
                  ...
                  style={{ backgroundColor: model.textColor, opacity: 0.2 }}
                />
              </div>
              {/* Precio */}
    ...
    return (
      ...
      >
        ...
        <div className="px-2 pt-1 shrink-0">
          ...
          <div
            className="relative w-full overflow-hidden mb-1.5"
            style={{ height: "58px", borderRadius: imgR === "999px" ? "16px" : imgR }}
          >
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(135deg, ${model.primaryColor}dd, ${model.accentColor}99)`,
              }}
            />
            <div
              className="absolute inset-0"
            ...
            />
            <div
              className="absolute top-1.5 left-2 text-[5px] font-bold tracking-widest uppercase"
              style={{
            ...
            <div
              className="absolute bottom-2 right-2 h-3.5 px-2 rounded-full flex items-center text-[5px] font-bold"
              style={{ backgroundColor: model.primaryColor, color: "#fff" }}
            >
              Añadir
            </div>
            ...
            <div key={i} className="flex-1 flex flex-col items-center gap-0.5">
              <div
                ...
                style={{
                  aspectRatio: "1/1",
                  borderRadius: "999px",
                  background: i % 2 === 0 ? `${model.primaryColor}cc` : `${model.accentColor}dd`,
        ...
        <div className="flex-1 overflow-hidden space-y-0.5 px-0 pt-1">
          ...
          <div className="relative overflow-hidden mx-0" style={{ height: "44px" }}>
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(90deg, ${model.primaryColor}cc, ${model.accentColor}88)`,
              }}
            />
            <div
              className="absolute inset-0"
            ...
            />
            <div
              className="absolute top-1 left-2 text-[4.5px] font-bold tracking-[0.3em] uppercase"
              style={{ color: model.isDark ? model.primaryColor : "#fff", opacity: 0.7 }}
            >
              Editorial
            </div>
            <div className="absolute bottom-1 left-2 right-2 flex items-center justify-between">
              <div
                className="h-1.5 rounded-sm w-20"
                style={{ backgroundColor: "#fff", opacity: 0.9 }}
              />
              <div
                className="h-3 px-1.5 flex items-center text-[4px] font-bold"
            ...
            {[0, 1].map((i) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-1.5">
                  <div
                    className="h-1 rounded-sm w-3/4 mb-0.5"
                    style={{ backgroundColor: "#fff", opacity: 0.85 }}
                  />
                  <div
      ...
      >
        ...
        <div className="px-2 pt-1 space-y-1 flex-1 overflow-hidden">
          ...
          <div
            ...
            style={{ height: "54px", borderRadius: imgR }}
          >
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(120deg, ${model.primaryColor}ee, ${model.accentColor}99)`,
              }}
            />
            <div
              className="absolute inset-0"
            ...
            {/* Glass tag */}
            <div
              className="absolute top-2 right-2 h-4 px-2 flex items-center rounded text-[4.5px] font-bold"
              style={{ backgroundColor: model.primaryColor, color: "#000", opacity: 0.9 }}
            >
              NUEVO
            </div>
            <div className="absolute bottom-0 left-0 p-2 space-y-0.5">
              <div
                className="h-1.5 rounded-full w-20"
                style={{ backgroundColor: "#fff", opacity: 0.9 }}
              />
          ...
          <div className="flex gap-1 flex-1 pb-1">
            {[0, 1].map((i) => (
              <div
                key={i}
                className="flex-1 relative overflow-hidden"
                style={{ borderRadius: imgR, minHeight: "52px" }}
              >
                <div
                  className="absolute inset-0"
                  style={{
        ...
        <div className="flex gap-1 px-2 pb-2 pt-1 flex-1 overflow-hidden">
          ...
          <div className="flex-1 relative overflow-hidden" style={{ borderRadius: imgR }}>
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(150deg, ${model.primaryColor}dd, ${model.accentColor}99)`,
              }}
            />
            <div
              className="absolute inset-0"
              style={{
                background: "linear-gradient(to top, rgba(0,0,0,0.78) 28%, rgba(0,0,0,0.08) 70%)",
              }}
            />
            <div
              className="absolute top-2 left-2 text-[4.5px] font-bold tracking-widest uppercase"
          ...
          {[0, 1].map((i) => (
            <div key={i} className="flex" style={{ height: "46%" }}>
              ...
              >
                {/* Tag diagonal */}
                <div
                  className="absolute top-1.5 left-2 text-[4.5px] font-black px-1.5 py-0.5 tracking-widest"
              ...
              {/* Columna de texto */}
              <div
                className="w-2/5 px-2 py-1.5 flex flex-col justify-center gap-1"
              ...
              >
                ...
                <div
                  className="h-3 rounded w-12 mt-0.5 flex items-center justify-center text-[4px] font-black"
                  style={{ backgroundColor: model.primaryColor, color: "#000" }}
                >
                  AÑADIR
                </div>
          ...
          >
            ...
            <div
              style={{
                ...
                background: i % 3 === 0 ? `${model.primaryColor}cc` : `${model.accentColor}dd`,
              }}
            />
            <div className="h-1 rounded-full w-4/5" style={{ ...muted }} />
            <div className="h-1.5 rounded-full w-1/2" style={{ ...mini }} />
...
function ColorSwatch({
  ...
  return (
    <div className="flex flex-wrap gap-2.5 items-center">
      ...
      {allowCustom && (
        <div
          className="flex items-center gap-2 border-l pl-2.5 ml-0.5"
...
function DisenoPage() {
  ...
  const [activeCustomizerTab, setActiveCustomizerTab] = useState<
    "estilo" | "colores" | "banners" | "ajustes" | "cintillo"
  >("estilo");
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between border-b pb-5 mb-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Diseña un catálogo espectacular y fácil de usar para tus clientes. Los cambios se
            reflejan en tiempo real.
          </p>
        </div>
        <Badge className="bg-primary/10 text-primary border border-primary/20 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
          {store.model && store.model !== "default"
            ? `Diseño ${store.model.toUpperCase()} Activo`
            : "Diseño Estándar Activo"}
        </Badge>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-start">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    Escoge el modelo visual idóneo para tus productos y marca.
                  </p>
                </div>
              </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center justify-between">
                          ...
                          {locked && (
                            <Badge
                              variant="outline"
                              className="text-[10px] font-bold uppercase tracking-widest bg-zinc-100 border-none text-zinc-500"
                            >
                              Bloqueado
                            </Badge>
                          )}
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="p-3 border-t bg-white flex flex-col gap-1">
                                  <div className="flex items-center justify-between">
                                    <span className="font-extrabold text-xs text-zinc-800">
                                      {model.name}
                                    </span>
                                    {isActive && (
                ...
                <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50/80 to-indigo-50/50 p-4.5 flex items-center gap-4 mt-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-xs text-blue-900">
                      Desbloquea diseños premium exclusivos
                    </p>
                    <p className="text-[11px] text-blue-700 mt-0.5">
                      Actualiza tu plan y obtén acceso a los{" "}
                      {MODELS.filter((m) => m.planLevel > userLevel).length} modelos avanzados
                      restantes.
                    </p>
                  </div>
                  <a
            ...
            <div className="rounded-3xl border border-zinc-200/85 bg-white p-6 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-550">
                    Personaliza los colores del catálogo para adaptarlos a tu identidad de marca.
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500">
                        Botones, precios y elementos destacados
                      </p>
                    </div>
                  </div>
                  {brandColor && (
              ...
              <div
                className={cn(
                  ...
                  isBgLocked ? "bg-zinc-100/40 opacity-75" : "bg-zinc-50/30",
                )}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div
                      className={cn(
                        ...
                        isBgLocked ? "bg-zinc-200" : "bg-primary/10",
                      )}
                    >
                      {isBgLocked ? (
                        <Lock className="h-4 w-4 text-zinc-500" />
                ...
                {isBgLocked ? (
                  <div className="rounded-xl border border-dashed bg-white px-4 py-3 flex items-center gap-3">
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${selectedModelDef?.bg}, ${selectedModelDef?.cardBg})`,
                      }}
                    />
                    <div>
                      <p className="text-xs font-bold text-zinc-800">Fondo Especial del Modelo</p>
                      <p className="text-[10px] text-zinc-550 leading-snug">
                        Este diseño utiliza un fondo diseñado exclusivamente para mantener su
                        elegancia.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-550">
                        Color principal de textos, títulos y descripciones
                      </p>
                    </div>
                  </div>
                  {textColor && (
            ...
            <div className="rounded-3xl border border-zinc-200/85 bg-white p-6 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-550">
                    Sube imágenes de portada para darle la bienvenida a tus visitantes.
                  </p>
                </div>
              </div>
              ...
              {!(selectedModel === "elite" || selectedModel === "portada") ? (
                <div className="rounded-3xl border border-dashed border-zinc-200 bg-zinc-50/50 p-8 text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    <h4 className="font-extrabold text-sm text-zinc-955">
                      El modelo actual no admite Portada
                    </h4>
                    <p className="text-xs text-zinc-555 max-w-sm mx-auto leading-relaxed">
                      Para poder agregar imágenes de portada y banners, por favor selecciona una
                      plantilla de diseño que lo soporte (como <strong>Elite</strong> o{" "}
                      <strong>Portada con Banner</strong>) en la pestaña de{" "}
                      <strong>Estilo & Plantilla</strong>.
                    </p>
                  </div>
                  <Button
                    type="button"
                ...
                <div className="space-y-6">
                  ...
                  {bannerImage && (
                    <div
                      className="relative w-full overflow-hidden rounded-2xl border shadow-inner"
                  ...
                  <div className="flex items-start gap-3 rounded-2xl bg-zinc-50 border px-4 py-3.5">
                    <svg
                      className="w-4 h-4 text-zinc-550 shrink-0 mt-0.5"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-zinc-555 leading-relaxed">
                        El banner se adapta al ancho total del catálogo. Recomendamos imágenes
                        horizontales limpias. Puedes usar la herramienta gratuita{" "}
                        <a
                        ...
                        para comprimir tus imágenes antes de subirlas.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <span className="text-xs font-bold text-zinc-800">
                        {bannerImage ? "Reemplazar imagen de portada" : "Subir imagen de portada"}
                      </span>
            ...
            <div className="rounded-3xl border border-zinc-200/85 bg-white p-6 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-555">
                    Ajustes detallados para pulir la apariencia final de tu catálogo.
                  </p>
                </div>
              </div>
              ...
              {selectedModel === "elite" || selectedModel === "portada" ? (
                <div className="space-y-4">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-[10px] text-zinc-500">
                      Controla cómo se integra la imagen de cabecera con el catálogo.
                    </p>
                  </div>
                    ...
                    {[
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[9px] text-zinc-555 leading-snug">
                            {style.desc}
                          </span>
                        </button>
                      );
                ...
                <div className="rounded-3xl border border-primary/20 bg-primary/5 p-6 flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-extrabold text-xs text-zinc-955">
                      Personalizador Avanzado Disponible
                    </h4>
                  </div>
                  <p className="text-[10px] text-zinc-650 leading-relaxed">
                    Tu plan **{store.plan.toUpperCase()}** incluye el Personalizador de Diseños
                    Premium. Configura tipografías personalizadas, estilos de tarjetas con sombras,
                    y temas específicos para tu nicho.
                  </p>
                  <Link
                ...
                <div className="rounded-3xl border border-zinc-200 bg-zinc-50/50 p-6 flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-extrabold text-xs text-zinc-955">
                      Ajustes Premium Bloqueados
                    </h4>
                  </div>
                  <p className="text-[10px] text-zinc-555 leading-relaxed">
                    Las configuraciones de tipografías premium, estilos de tarjetas de producto
                    (borde flotante, sombra suave) y cortes especiales están reservadas para el
                    personalizador avanzado en los planes <strong>Pro</strong> e{" "}
              ...
              <div className="rounded-2xl border border-zinc-200 bg-zinc-50/30 p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-[10px]">
                  <div className="space-y-1">
                    <span className="text-zinc-550 block font-semibold">
                  ...
                  <div className="space-y-1">
                    ...
                    {(() => {
                      const layoutKey =
                        selectedModelDef?.layout === "banner_grid"
                          ? "banner_grid"
                          : selectedModelDef?.layout;
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select
                          ...
                          className="flex h-10 w-full rounded-xl border border-zinc-250 bg-white px-3.5 py-1 text-xs shadow-sm focus:outline-none focus:ring-1 focus:ring-primary cursor-pointer text-zinc-800"
                        >
                      ...
                      {promoBarActionType === "coupon" && (
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className="flex h-10 w-full rounded-xl border border-input bg-transparent px-3.5 py-1 text-xs shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary uppercase"
                          />
                        </div>
                      )}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex gap-2 items-center">
                            ...
                            <input
                              ...
                              className="flex-1 h-8 rounded-lg border border-input bg-transparent px-2 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                            />
                          </div>
                        </div>
        ...
        <div className="hidden lg:flex lg:sticky lg:top-6 w-full lg:w-[410px] flex-col items-center shrink-0">
          <div
            className="relative w-[390px] h-[780px] bg-zinc-950 rounded-[48px] p-3.5 border-[6px] border-zinc-800 ring-1 ring-zinc-700/50 flex flex-col overflow-hidden select-none"
            style={{
          ...
          <p className="text-[11px] text-muted-foreground text-center mt-4 max-w-[320px] leading-relaxed">
            <strong>Simulador Interactivo:</strong> Puedes hacer scroll, navegar categorías y
        ...
        <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md rounded-full shadow-2xl border px-4 py-2 flex items-center justify-between gap-3 animate-in slide-in-from-bottom-4 duration-300 w-full">
          ...
          {isDirty ? (
            <div className="flex items-center gap-2.5 ml-auto text-xs">
              ...
              <Button
                onClick={save}
                className="rounded-full bg-primary hover:bg-primary/95 text-white font-bold px-5 py-2 text-xs shadow-lg transition-transform active:scale-95 border-none cursor-pointer"
              >
