...
- Si **> 0** → la DB **rechaza el borrado** y devuelve: _"No se puede borrar: N tiendas usan este plan. Desactívalo o migra esas tiendas primero."_
...
_Documento de modelado. No ejecuta cambios._
